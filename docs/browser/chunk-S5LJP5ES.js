import{B as h,k as n}from"./chunk-NFCC2EWM.js";import"./chunk-PUAS7KUQ.js";import{$ as d,Na as o,Ua as e,Va as t,Wa as m,eb as a,mb as r,ya as i}from"./chunk-WUAR7S4Q.js";var u=(()=>{class c{constructor(){this.codeImport="import { MagmaInputModule } from 'magma-core';",this.codeBasicExamp=`<magma-table [loading]="false">
    <thead>
      <tr>
...
</magma-table>`}static{this.\u0275fac=function(s){return new(s||c)}}static{this.\u0275cmp=d({type:c,selectors:[["app-table"]],standalone:!0,features:[r],decls:13,vars:2,consts:[[1,"font-base-section"],[1,"description-section"],[3,"code"]],template:function(s,l){s&1&&(e(0,"h2",0),a(1,"Table is a flexible component for displaying structured data in rows and columns"),t(),e(2,"p",1),a(3,"Table"),t(),m(4,"br"),e(5,"h3"),a(6,"Import"),t(),m(7,"app-code-template",2)(8,"br"),e(9,"h3"),a(10,"Basic"),t(),m(11,"br")(12,"app-code-template",2)),s&2&&(i(7),o("code",l.codeImport),i(5),o("code",l.codeBasicExamp))},dependencies:[n,h],styles:["[_nghost-%COMP%]{flex:1;overflow-y:auto;padding-right:1rem;margin-right:-1rem}"]})}}return c})();export{u as TableComponent};
